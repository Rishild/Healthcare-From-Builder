...
// Update the props interface to include pageImages
...
// Update the component to handle pageImages
export function ExactFormPreview({
  formTitle,
  formFields,
  formLayout,
  pageImages,
  ...
  // Set up total pages and current page from layout or pageImages
  useEffect(() => {
    if (formLayout?.pages) {
  ...
  const currentBackgroundImage =
    pageImages && pageImages.length >= currentPage
      ? pageImages[currentPage - 1]
      : originalImageUrl || formLayout?.backgroundImage || ""
